...
Gradient Boosting returned the highest Adjusted R-squared value: 0.554.

I then employed RandomizedSearchCV to determine the optimal settings for the hyperparameters.
#### The model returned an Adjusted R-squared value of 0.586.

## Final Model Evaluation

#### The final model returned an Adjusted R-squared value of 0.688.
...
At this point, I feel this result is a "proof of concept" for the project. The Adjusted R-squared value of 0.684 on the final model does not satisfy me that it could be used for predictions in the real world at this time. However, there is still the possibility of building upon this start and attempting to improve its' ability.

If I could get the Adjusted R-squared above 0.9, it would be a useful tool for administrators and superinendents to implement in managing their schools.
